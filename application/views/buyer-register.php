...
<body>
  ...
  <div class="container">
      <h2 class="text-center text-green text-uppercase ptb-50" style=" background-color:#7C8B2E;">Buyer Registration Form</h2>
         <div class="alert alert-info">All (<span class="text-danger"><i class="fa fa-asterisk"></i></span>) marked fields are mandatory</div>
      <form   method="POST" role="form" id="buyerRegisterForm" enctype="multipart/form-data" accept-charset="utf-8">
        <div class="row">
          ...
          <div class="col-md-4 form-group">
            <label class="control-label requiredlbl" for="ceo">CEO Name:</label>
        ...
        <div class="col-md-4 form-group">
          <label class="control-label " for="certify_img">Choose Company Image :</label>
          <input type="file" class="form-control" id="certify_img"  name="certify_img">
        </div>  
        </div>
        <div class="row">    
        <div class="col-md-4 form-group">
          <label class="control-label requiredlbl" for="test_report">Do you need test report? :</label>
      ...
      <div class="row">  
        ...
        <div class="col-md-12"><h4 class="frm-headBg"> Products Interested to buy</h4>
        </div>
    ...
    <div class="row">          
      <div class="col-md-12 form-group text-center">      
        <input type="submit" name="submit_buyer" class="btn btn-primary" value="Submit">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#state').on('change',function(){
      ...
      if(stateID){
        $.ajax({
          type:'POST',
          url: "<?php echo base_url();?>buyer_register/get_city",
  ...
  $(document).ready(function(){
    ...
    $('#buyerRegisterForm').formValidation({
      framework: 'bootstrap',
      fields: {
        fullname: {
          validators: {
        ...
        username: {
            validators: {
              ...
              remote: {
                ...
                url: '<?php echo base_url() ?>check-username-exists/buyer',
                type: 'POST'
              }
            }
          },
        ...
        types: {
          validators: {
            notEmpty: {
              message: 'The types of buyer is required'
            }
          }
        },
        test_report: {
...
.on('click', '.addButton', function() {
  ...
  $option   = $clone.find('[name="pr_name[]"] , [name="pr_desc[]"] , [name="pr_qty[]"] , [name="pr_quality[]"] , [name="pr_price[]"]');
            ...
            // Add new field
            $('#buyerRegisterForm').formValidation('addField', $option);
        ...
        .on('click', '.removeButton', function() {
          ...
          $option = $row.find('[name="option[]"]');
            ...
            // Remove field
            $('#buyerRegisterForm').formValidation('removeField', $option);
          })
        ...
        .on('success.form.fv', function(e) {
         ...
         $.ajax({  
           url: "<?php echo base_url();?>buyer_register/create_buyer",  
           method:"POST",  
           ...
           {  console.log(response);
            ...
            if(response = 'success' ){
              ...
              swal({
                title: "Success!",
                text: "buyer has been added successfully",
                type: "success",
    ...
    <script type="text/javascript">
      $(function () {
       $('.datepicker').datepicker({}).on('changeDate', function(e) {
            ...
            $('#buyerRegisterForm').formValidation('revalidateField', 'pr_avlFrom[]');
            $('#buyerRegisterForm').formValidation('revalidateField', 'pr_avlTo[]');
          });
     });
