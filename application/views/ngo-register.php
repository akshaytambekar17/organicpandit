...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
      <div class="row">
        <h2 class="text-center text-green text-uppercase ptb-50" style=" background-color:#7C8B2E;">NGO Registration Form</h2>
  ...
  <script>
      ...
      $('#state').on('change',function(){
        ...
        if(stateID){
          $.ajax({
            type:'POST',
            url: "<?php echo base_url();?>ngo_register/get_city",
    ...
    $(document).ready(function() {
      $('#RegisterForm').formValidation({
          ...
          username: {
            validators: {
              ...
              remote: {
                ...
                url: '<?php echo base_url() ?>check-username-exists/ngo',
                type: 'POST'
              }
            }
          },
       ...
       $.ajax({  
         url: "<?php echo base_url();?>ngo_register/create_ngo",  
         method:"POST",  
         ...
         {  console.log(response);
          ...
          if(response = 'success' ){
            ...
            swal({
              title: "Success!",
              text: "NGO has been added successfully",
              type: "success",
