<div class="row">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="organization_name"  class="form-control" id="organization_name" placeholder="Institutions Name" value="<?= set_value('organization_name')?>">
    ...
    <!--                <div class="form-group col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label class="control-label label-required" for="company_image">Choose Institutions Image</label>
