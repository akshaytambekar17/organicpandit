            ...
            <div class="box-body">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label class="control-label label-required" for="organization_name">Agency Name</label>
                            <input type="text" name="organization_name"  class="form-control" id="organization_name" placeholder="Agency Name" value="<?= set_value('organization_name')?>">
