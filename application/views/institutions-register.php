...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
      <div class="row">
        <h2 class="text-center text-green text-uppercase ptb-50" style=" background-color:#7C8B2E;">Institutions Registration Form</h2>
      ...
      <form  method="POST" role="form" id="RegisterForm" enctype="multipart/form-data" accept-charset="utf-8">
          <div class="row">
            ...
            <div class="col-md-4 form-group">
              <label class="control-label requiredlbl" for="comapny_name">Name of the Institutions  :</label>
              <input type="text" class="form-control" id="comapny_name" placeholder="Enter Name of the Institutions    " name="comapny_name">
            </div>  
            </div>
            <div class="row">  
            <div class="col-md-4 form-group">
          ...
          <div class="col-md-4 form-group">
            ...
            <div class="row">
            <div class="col-md-4 form-group">
              <label class="control-label" for="catalouge">Upload Product Catalogue  :</label>
              <input type="file" class="form-control" id="catalouge"  name="catalouge">
            </div>    
            <div class="col-md-4 form-group">
  ...
  <script>
      ...
      $('#state').on('change',function(){
        ...
        if(stateID){
          $.ajax({
            type:'POST',
            url: "<?php echo base_url();?>institutions_register/get_city",
    ...
    $(document).ready(function() {
      $('#RegisterForm').formValidation({
          ...
          username: {
            validators: {
              ...
              remote: {
                ...
                url: '<?php echo base_url() ?>check-username-exists/institutions',
                type: 'POST'
              }
            }
          },
       ...
       $.ajax({  
         url: "<?php echo base_url();?>institutions_register/create_institutions",  
         method:"POST",  
         ...
         {  console.log(response);
          ...
          if(response = 'success' ){
            ...
            swal({
              title: "Success!",
              text: "Institutions has been added successfully",
              type: "success",
