...
<body>
  ...
  <div class="container">
    <h2 class="text-center text-green text-uppercase ptb-50" style=" background-color:#7C8B2E;">Farmer Registration Form</h2>
        ...
        <div class="col-md-4 form-group">
          ...
          <select class="form-control" name="agency" id="agency">
            ...
            <?php foreach ($agencies as $agency):?>
              <option value="<?php echo $agency->agency_name; ?>"><?php echo $agency->agency_name; ?></option>
            <?php endforeach;?>
                      </select><br>
              <label class="control-label " for="username">Agency Username</label>
              <input type = "text" name = "agency_username" id="username" /> 
        </div> 
        <div class="col-md-4 form-group">
    ...
    $(document).ready(function(){
      $('#agency').on('change',function(){
        ...
        if(ID){
          $.ajax({
            type:'POST',
            url: "<?php echo base_url();?>farmer_register/get_username",
            data:'id='+ID,
            success:function(html){
              $('#username').html(html);
              console.log('in');
          ...
          $('#username').html('<option value="">Select Agency first</option>'); 
          console.log('out');
        }
      });
    });
