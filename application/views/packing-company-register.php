...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
      <div class="row">
        <h2 class="text-center text-green text-uppercase ptb-50" style=" background-color:#7C8B2E;">Packing Company  Registration Form</h2>
  ...
  <script>
    ...
    $(document).ready(function() {
      $('#RegisterForm').formValidation({
       ...
       $.ajax({  
         url: "<?php echo base_url();?>packing_company_register/create_packing_company",  
         method:"POST",  
         ...
         {  console.log(response);
          ...
          if(response = 'success' ){
            ...
            swal({
              title: "Success!",
              text: "Packing company has been added successfully",
              type: "success",
