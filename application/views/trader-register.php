...
<body>
  ...
  <div class="container">
      <h2 class="text-center text-green text-uppercase ptb-50" style=" background-color:#7C8B2E;">Trader Registration Form</h2>
         <div class="alert alert-info">All (<span class="text-danger"><i class="fa fa-asterisk"></i></span>) marked fields are mandatory</div>
      <form   method="POST" role="form" id="traderRegisterForm" enctype="multipart/form-data" accept-charset="utf-8">
        <div class="row">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#state').on('change',function(){
        ...
        if(stateID){
          $.ajax({
            type:'POST',
            url: "<?php echo base_url();?>trader_register/get_city",
    ...
    $(document).ready(function(){
      ...
      $('#traderRegisterForm').formValidation({
        framework: 'bootstrap',
        fields: {
          fullname: {
            validators: {
          ...
          username: {
            validators: {
              ...
              remote: {
                ...
                url: '<?php echo base_url() ?>check-username-exists/trader',
                type: 'POST'
              }
            }
          },
...
.on('click', '.addButton', function() {
  ...
  $option   = $clone.find('[name="pr_name[]"] , [name="pr_desc[]"] , [name="pr_qty[]"] , [name="pr_quality[]"] , [name="pr_price[]"]');
            ...
            // Add new field
            $('#traderRegisterForm').formValidation('addField', $option);
        ...
        .on('click', '.removeButton', function() {
          ...
          $option = $row.find('[name="option[]"]');
            ...
            // Remove field
            $('#traderRegisterForm').formValidation('removeField', $option);
          })
        ...
        .on('success.form.fv', function(e) {
          ...
          $.ajax({  
            url: "<?php echo base_url();?>trader_register/create_trader",  
            method:"POST",  
            ...
            {  console.log(response);
              ...
              if(response = 'success' ){
                ...
                swal({
                  title: "Success!",
                  text: "Trader has been added successfully",
                  type: "success",
                  showCancelButton: false,
                  timer: 2000
                });
                           // document.getElementById("traderRegisterForm").reset();
                         }
                       }  
                     }); 
    ...
    <script type="text/javascript">
      $(function () {
        $('.datepicker').datepicker({}).on('changeDate', function(e) {
            ...
            $('#traderRegisterForm').formValidation('revalidateField', 'pr_avlFrom[]');
            $('#traderRegisterForm').formValidation('revalidateField', 'pr_avlTo[]');
          });
      });
