...
<body>
  ...
  <div class="container">
      <h2 class="text-center text-green text-uppercase ptb-50" style=" background-color:#7C8B2E;">Processor Registration Form</h2>
         <div class="alert alert-info">All (<span class="text-danger"><i class="fa fa-asterisk"></i></span>) marked fields are mandatory</div>
      <form   method="POST" role="form" id="processorRegisterForm" enctype="multipart/form-data" accept-charset="utf-8">
        <div class="row">
        ...
        <div class="row">  
          ...
          <div class="col-md-12"><h4 class="frm-headBg"> Product Details</h4>
          </div>
        ...
        <div class="row">          
          <div class="col-md-12 form-group text-center">      
            <input type="submit" name="submit_processor" class="btn btn-primary" value="Submit">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#state').on('change',function(){
        ...
        if(stateID){
          $.ajax({
            type:'POST',
            url: "<?php echo base_url();?>processor_register/get_city",
    ...
    $(document).ready(function(){
      ...
      $('#processorRegisterForm').formValidation({
        framework: 'bootstrap',
        fields: {
          fullname: {
            validators: {
          ...
          username: {
            validators: {
              ...
              remote: {
                ...
                url: '<?php echo base_url() ?>check-username-exists/processor',
                type: 'POST'
              }
            }
          },
...
.on('click', '.addButton', function() {
  ...
  $option   = $clone.find('[name="pr_name[]"] , [name="pr_desc[]"] , [name="pr_qty[]"] , [name="pr_quality[]"] , [name="pr_price[]"]');
            ...
            // Add new field
            $('#processorRegisterForm').formValidation('addField', $option);
        ...
        .on('click', '.removeButton', function() {
          ...
          $option = $row.find('[name="option[]"]');
            ...
            // Remove field
            $('#processorRegisterForm').formValidation('removeField', $option);
          })
        ...
        .on('success.form.fv', function(e) {
          ...
          $.ajax({  
            url: "<?php echo base_url();?>processor_register/create_processor",  
            method:"POST",  
            ...
            {  console.log(response);
              ...
              if(response = 'success' ){
                ...
                swal({
                  title: "Success!",
                  text: "Processor has been added successfully",
                  type: "success",
                  showCancelButton: false,
                  timer: 2000
                });
                           // document.getElementById("processorRegisterForm").reset();
                         }
                       }  
                     }); 
    ...
    <script type="text/javascript">
      $(function () {
        $('.datepicker').datepicker({}).on('changeDate', function(e) {
            ...
            $('#processorRegisterForm').formValidation('revalidateField', 'pr_avlFrom[]');
            $('#processorRegisterForm').formValidation('revalidateField', 'pr_avlTo[]');
          });
      });
