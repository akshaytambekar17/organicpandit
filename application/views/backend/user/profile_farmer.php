...
<!--                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="Product[from_date][]" class="form-control picker-date pull-right" id="from_date" placeholder="From Date" value="<?= !empty($val_product['from_date'])?date('d/m/Y', strtotime($val_product['from_date'])):set_value('Product[from_date][]') ?>">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group date">
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                <input type="text" name="Product[to_date][]" class="form-control picker-date pull-right" id="to_date" placeholder="To Date" value="<?= !empty($val_product['to_date'])?date('d/m/Y', strtotime($val_product['to_date'])):set_value('Product[to_date][]') ?>">
                                            </div>        
                                        </div>
                                        <div class="form-group col-md-3">
...
<!--                                    <input type="text" name="Crop[area][]"  class="form-control" id="area" placeholder="Area (in acre's)" value="<?= !empty($val_crop['area'])?$val_crop['area']:set_value('Crop[area][]') ?>" maxlength="5" onkeypress="numberValidation(event)">-->
                                    ...
                                    <select class="form-control select2" name="Crop[area][]" style="width:100%">
                                        ...
                                        <?php foreach( getAreaInNumber() as $keyArea => $valArea ) { 
                                                $selected = '';
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="Crop[date_sown][]" class="form-control picker-date pull-right" id="date_sown" placeholder="Date of Sown" value="<?= (!empty($val_crop['date_sown'])&& $val_crop['date_sown'] != '0000-00-00')?date('d/m/Y',strtotime($val_crop['date_sown'])):set_value('Crop[date_sown][]') ?>">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="Crop[date_harvest][]" class="form-control picker-date pull-right" id="date_harvest" placeholder="Date of Harvest" value="<?= (!empty($val_crop['date_harvest']) && $val_crop['date_harvest'] != '0000-00-00')?date('d/m/Y',strtotime($val_crop['date_harvest'])):set_value('Crop[date_harvest][]') ?>">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="Crop[date_inspection][]" class="form-control picker-date pull-right" id="date_inspection" placeholder="Date of Inspection" value="<?= (!empty($val_crop['date_inspection'])&& $val_crop['date_inspection'] != '0000-00-00')?date('d/m/Y',strtotime($val_crop['date_inspection'])):set_value('Crop[date_inspection][]') ?>">
