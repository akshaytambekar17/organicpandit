<div class="row">
            ...
            <div class="box-body">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label class="control-label label-required" for="organization_name">Shop Name</label>
                            <input type="text" name="organization_name"  class="form-control" id="organization_name" placeholder="Shop Name" value="<?= !empty($arrUserDetails['organization_name']) ? $arrUserDetails['organization_name'] : set_value('organization_name') ?>">
    ...
    <!--                <div class="form-group col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label class="control-label" for="company_image">Choose Shop Image</label>
