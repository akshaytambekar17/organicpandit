                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="organization_name"  class="form-control" id="organization_name" placeholder="Company Name" value="<?= !empty($arrUserDetails['organization_name']) ? $arrUserDetails['organization_name'] : set_value('organization_name') ?>">
