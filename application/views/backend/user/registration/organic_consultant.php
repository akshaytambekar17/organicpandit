                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <?php if(!empty($arrUserDetails['resume'])){ ?>
                                <a href="<?= base_url()?>assets/images/gallery/<?= $arrUserDetails['resume']?>" download><h5>Download <?= $arrUserDetails['resume']?></h5></a>
                                <input type="hidden" name="resume_hidden" value="<?= $arrUserDetails['resume']?>">
                            <?php } ?>    
                            <span class="has-error"><?php echo form_error('resume'); ?></span>
                        </div>
                    </div>
