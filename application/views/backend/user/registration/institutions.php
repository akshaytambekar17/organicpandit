                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="ceo_name"  class="form-control" id="ceo_name" placeholder="Director/CEO Name" value="<?= !empty($arrUserDetails['ceo_name']) ? $arrUserDetails['ceo_name'] : set_value('ceo_name') ?>">
                            <span class="has-error"><?php echo form_error('ceo_name'); ?></span>
                        </div>
                        <div class="form-group col-md-4">
                            <label class="control-label label-required" for="organization_name">Institutions Name</label>
                            <input type="text" name="organization_name"  class="form-control" id="organization_name" placeholder="Institutions Name" value="<?= !empty($arrUserDetails['organization_name']) ? $arrUserDetails['organization_name'] : set_value('organization_name') ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label class="control-label" for="company_image">Choose Institutions Image</label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <?php if(!empty($arrUserDetails['product_catalogue'])){ ?>
                                <a href="<?= base_url()?>assets/images/gallery/<?= $arrUserDetails['product_catalogue']?>" download><h5>Download <?= $arrUserDetails['product_catalogue']?></h5></a>
                                <input type="hidden" name="product_catalogue_hidden" value="<?= $arrUserDetails['product_catalogue']?>">
                            <?php } ?>    
