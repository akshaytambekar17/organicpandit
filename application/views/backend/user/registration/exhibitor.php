                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" name="date_of_exhibition" class="form-control picker-date pull-right" id="to_date" placeholder="Date of Exhibition" value="<?= ( true == isset( $arrUserExhibitionDetails['date_of_exhibition'] ) && true == isVal( $arrUserExhibitionDetails['date_of_exhibition'] ) ) ? date( 'd/m/Y', strtotime( $arrUserExhibitionDetails['date_of_exhibition'] ) ) : set_value('date_of_exhibition') ?>">
                            </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="about_exhibition"  class="form-control" id="about_exhibition" placeholder="About Exhibition" value="<?= ( true == isset( $arrUserExhibitionDetails['about_exhibition'] ) && true == isVal( $arrUserExhibitionDetails['about_exhibition'] ) ) ? $arrUserExhibitionDetails['about_exhibition'] : set_value('about_exhibition') ?>">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="participate"  class="form-control" id="participate" placeholder="Who Should Participate" value="<?= ( true == isset( $arrUserExhibitionDetails['participate'] ) && true == isVal( $arrUserExhibitionDetails['participate'] ) ) ? $arrUserExhibitionDetails['participate'] : set_value('participate') ?>">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="visitor_fees"  class="form-control" id="visitor_fees" placeholder="Visitor Fees" value="<?= ( true == isset( $arrUserExhibitionDetails['visitor_fees'] ) && true == isVal( $arrUserExhibitionDetails['visitor_fees'] ) ) ? $arrUserExhibitionDetails['visitor_fees'] : set_value('visitor_fees') ?>">
