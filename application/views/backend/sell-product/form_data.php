...
<!--                        <h3 class="box-title">Data Table With Full Features</h3>-->
                    ...
                    <form method="post" enctype="multipart/form-data" action="<?= !empty( $arrSellProductDetails ) ? site_url('sell-product/update?id='.$arrSellProductDetails['sell_product_id']) : site_url('sell-product/create')?>" name="sell-product-form" >
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control select2" name="delivery_location" id="js-delivery-location">
                                        ...
                                        <?php foreach( $arrCitiesList as $arrCityDetails ) {
		                                        $strSelected = '';
		                                        if( $arrCityDetails['id'] == $arrSellProductDetails['delivery_location']  ) {
			                                        $strSelected = 'selected="selected"';
		                                        }
                                        ?>
                                            <option value="<?= $arrCityDetails['id'] ?>" <?= set_select('delivery_location', $arrCityDetails['id']); ?> <?= $strSelected; ?> ><?= $arrCityDetails['name'] ?></option>
                                        <?php } ?>
                                    </select>
