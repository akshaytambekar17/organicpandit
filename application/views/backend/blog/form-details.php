<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url()?>admin/blogs">User Soil List</a></li>
...
<!--                        <h3 class="box-title">Data Table With Full Features</h3>-->
                    ...
                    <form method="post" enctype="multipart/form-data" action="<?= ( true == isset( $arrBlogDetails ) ) ? base_url() . 'admin/blogs/update?id=' . $arrBlogDetails['id'] : base_url() . 'admin/blogs/add' ?>" name="blog-form">
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea id="js-ck-editor" name="description" rows="10" cols="80"><?= true == isset( $arrBlogDetails['description'] ) ? $arrBlogDetails['description'] : '' ?></textarea>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <?php if( true == isset( $arrBlogDetails['blog_image'] ) && ( true == isStrVal( $arrBlogDetails['blog_image'] ) ) ) { ?>
                                            <br>
                                            <img src="<?= base_url()?>assets/blogs/images/blogs/<?= $arrBlogDetails['blog_image']?>" width="70px" height="70px">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="form-control js-select2" name="blog_status">
