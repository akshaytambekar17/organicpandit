...
class Org_labs_register extends CI_Controller {


  function __construct(){
    parent:: __construct();
    $this->load->model('org_labs_model');
  }


    public function index()
  {
    $data['states'] =  $this->org_labs_model->get_state();
    $this->load->view('org-labs-register', $data);
  }
...
// get cities
  public function get_city(){
   ...
   $this->org_labs_model->all_city(); 

 }

// insert org_labs

  public function create_org_labs(){
 ...
 $this->org_labs_model->insert_org_labs($profile, $company_images, $video, $catalouge); 
} 

}
// insert org_labs close
