...
class org_input_register extends CI_Controller {


  function __construct(){
    parent:: __construct();
    $this->load->model('org_input_model');
  }


    public function index()
  {
    $data['states'] =  $this->org_input_model->get_state();
    $this->load->view('org-input-register', $data);
  }
...
// get cities
  public function get_city(){
   ...
   $this->org_input_model->all_city(); 

 }

// insert org_input

  public function create_org_input(){
 ...
 $this->org_input_model->insert_org_input($profile, $company_images, $video, $catalouge); 
} 

}
// insert org_input close
