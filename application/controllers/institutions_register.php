...
class Institutions_register extends CI_Controller {
  ...
  {
    $data['states'] =  $this->institutions_model->get_state();
    $this->load->view('institutions-register', $data);
  }
...
// get cities
  public function get_city(){
   ...
   $this->institutions_model->all_city(); 

 }

// insert institutions

  public function create_institutions(){
 ...
 $this->institutions_model->insert_institutions($profile, $company_images, $video, $catalouge); 
} 

}
// insert institutions close
