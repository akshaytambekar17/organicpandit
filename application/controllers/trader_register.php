...
class Trader_register extends CI_Controller {
  ...
  public function index()
  {
    ...
    $data['states'] =  $this->trader_model->get_state();
    $data['agencies'] =  $this->trader_model->get_agency();
    $this->load->view('trader-register', $data);
  }
...
$this->trader_model->insert_trader($profile, $certify_img, $video); 
} 
