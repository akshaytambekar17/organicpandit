...
class Buyer_register extends CI_Controller {
  ...
  public function index()
  {
    ...
    $data['states'] =  $this->buyer_model->get_state();
    $data['agencies'] =  $this->buyer_model->get_agency();
...
// get cities
 ...
 $this->buyer_model->insert_buyer($profile, $certify_img, $video); 
} 
