...
class Packing_company_register extends CI_Controller {


  function __construct(){
    parent:: __construct();
    $this->load->model('packing_company_model');
  }


    public function index()
  {
    $data['states'] =  $this->packing_company_model->get_state();
    $this->load->view('packing-company-register', $data);
  }
...
// get cities
  public function get_city(){
   ...
   $this->packing_company_model->all_city(); 

 }

// insert packing_company

  public function create_packing_company(){
 ...
 $this->packing_company_model->insert_packing_company($profile, $company_images, $video, $catalouge); 
} 

}
// insert packing_company close
