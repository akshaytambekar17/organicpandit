...
class Org_restaurant_register extends CI_Controller {


  function __construct(){
    parent:: __construct();
    $this->load->model('org_restaurant_model');
  }


    public function index()
  {
    $data['states'] =  $this->org_restaurant_model->get_state();
    $this->load->view('org-restaurant-register', $data);
  }
...
// get cities
  public function get_city(){
   ...
   $this->org_restaurant_model->all_city(); 

 }

// insert Org_restaurant

  public function create_org_restaurant(){
 ...
 $this->org_restaurant_model->insert_org_restaurant($profile, $company_images, $video, $catalouge); 
} 

}
// insert Org_restaurant close
