				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Farmer Product </li>
							<li><a href="farmproduct.php"><button class="btn btn-success">Add New Farmer Product</button></a></li>
							<li><a href="export3.php"><button class="btn btn-success">Export</button></a></li>
						</ul><!-- /.breadcrumb --->
					...
					<!-- ******************* Start page-content *******************-->
					<?php require_once("partials/farmerproduct.php");?>
					<!-- ******************* /.page-content *******************-->
