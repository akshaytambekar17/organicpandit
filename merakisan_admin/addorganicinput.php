				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Organic Input</li>
						<!--	<li> <button class="right btn btn-success" id="show">Add Organic Input</button></li> -->
							<li><a href="exportinput.php"><button class="btn btn-success">Export</button></a></li>
					...
					<?php 
						...
						require_once("partials/inputlist.php");
