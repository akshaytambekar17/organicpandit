<?php
	...
	$sql = "SELECT `id`, `fullname`,`username`,`email`,`landline`,`mobile`,`state`,`city`,`address`,`pancard`,
	               `aadharcard`,`story`,`certification`,`visitq`,`test_report`,`acc_bank`,`acc_name`,
	               `acc_no`,`ifsc_code`,`date` FROM `tbl_farmer` ";
	...
	$fileName = "Farmerlist" . date('Y-m-d') . ".xls";
