				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Delivery Boy Register </li>
							<li><a href="delivery.php"><button class="btn btn-success">Add New Delivery Boy </button></a></li>
							<li><a href="export15.php"><button class="btn btn-success">Export</button></a></li>
						</ul><!-- /.breadcrumb -->
					...
					<!-- ******************* Start page-content *******************-->
					<?php require_once("partials/deliboy.php");?>
					<!-- ******************* /.page-content *******************-->
