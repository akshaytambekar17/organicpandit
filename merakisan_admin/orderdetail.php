				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li><a href="orderdetail.php" class="active">Orders</a></li>
							<li><a href="export4.php"><button class="btn btn-success">Export Orders</button></a></li>
							<li><a href="export17.php"><button class="btn btn-success">Export Quantity</button></a></li>
						</ul><!-- /.breadcrumb -->
					...
					<?php if(isset($_GET['id'])){
						require_once("partials/sorderdetail.php");
					}
					else
					{
