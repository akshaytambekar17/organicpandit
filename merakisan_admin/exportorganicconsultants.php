<?php
	...
	$sql = "SELECT `id`, `fullname`,`username`,`email`,`landline`,`mobile`,`state`,`city`,`address`,`gst`,
	               `aadharcard`,`story`,`website`,`resume`,`acc_bank`,`acc_name`,
	               `acc_no`,`ifsc_code`,`date` FROM `tbl_org_consultant` ";
	...
	$fileName = "Organicconsultantlist" . date('Y-m-d') . ".xls";
