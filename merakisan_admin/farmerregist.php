				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Farmer Register </li>
							<li><a href="farmerregist.php"><button class="btn btn-success">Add New Farmer </button></a></li>
							<li><a href="export2.php"><button class="btn btn-success">Export</button></a></li>
						</ul><!-- /.breadcrumb -->
					...
					<!-- ******************* Start page-content *******************-->
					<?php require_once("partials/farmerreg.php");?>
					<!-- ******************* /.page-content *******************-->
