<?php
	...
	$sql = "SELECT `id`, `fullname`,`username`,`email`,`landline`,`mobile`,`state`,`city`,`address`,`gst`,
	               `aadharcard`,`story`,`website`,`types`,`test_report`,`acc_bank`,`acc_name`,
	               `acc_no`,`ifsc_code`,`date`,`ceo` FROM `tbl_buyer` ";
	...
	$fileName = "Buyerlist" . date('Y-m-d') . ".xls";
