				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li><a href="productadd.php?new=addnew"><button class="btn btn-success" name="new">Add new Product </button></a></li>
							
							<li> <button class="right btn btn-success" id="show">Add product</button></li>
							<li><a href="export.php"><button class="btn btn-success">Export</button></a></li>
					...
					{
						require_once("partials/showproduct.php");
					}
					else
					{
						require_once("partials/subadmin.php");
					}
