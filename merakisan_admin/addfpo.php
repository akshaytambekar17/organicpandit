				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">FPO</li>
						<!--	<li> <button class="right btn btn-success" id="show">Add FPO</button></li> -->
							<li><a href="exportfpo.php"><button class="btn btn-success">Export</button></a></li>
					...
					<?php 
						...
						require_once("partials/fpolist.php");
