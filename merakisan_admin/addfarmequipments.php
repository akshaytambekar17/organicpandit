				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Farm Equipment</li>
						<!--	<li> <button class="right btn btn-success" id="show">Add Farm Equipment</button></li> -->
							<li><a href="exportfarmequipments.php"><button class="btn btn-success">Export</button></a></li>
					...
					<?php 
						...
						require_once("partials/equipmentlist.php");
