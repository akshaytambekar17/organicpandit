				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Buyer Product</li>
						<!--	<li> <button class="right btn btn-success" id="show">Add Farmer</button></li> -->
							<li><a href="exportproductbuyer.php"><button class="btn btn-success">Export</button></a></li>
					...
					<?php require_once("partials/productbuyer.php");?>
					<!-- ******************* /.page-content *******************-->
