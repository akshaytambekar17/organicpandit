<?php
	...
	$sql = "SELECT `id`, `pr_id`, `pr_name`, `pr_desc`, `pr_avlFrom`, `pr_avlTo`, `pr_qty`, `pr_quality`, `pr_price`, `pr_date` FROM `tbl_pr_trader` ";
	...
	$fileName = "Traderproductlist" . date('Y-m-d') . ".xls";
