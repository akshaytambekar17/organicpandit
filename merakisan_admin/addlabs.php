			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<!--	<li> <button class="right btn btn-success" id="show">Add Labs</button></li> -->
							<li><a href="exportlabs.php"><button class="btn btn-success">Export</button></a></li>
					...
					<?php 
						...
						require_once("partials/labslist.php");
