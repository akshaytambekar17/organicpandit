					...
					<?php
						...
						{	
							...
							$id= $_GET['id'];
							$sql = "select * from `tbl_org_consultant` where id='$id'";
						...
						{
							$did= $_GET['did'];
							$sql = "delete  from `tbl_org_consultant` where `id`='$did'";
				...
				$query = mysqli_query($db, "INSERT INTO `tbl_org_consultant`(`fullname`, `username`,`email`,`landline`,`mobile`,`state`,`city`,`address`,`gst`,
				                                                `aadharcard`,`story`,`profile`,`website`,`company_images`,`video`,`acc_bank`,`acc_name`,`acc_no`,`ifsc_code`) 
				                                             VALUES ('$fullname','$username','$email','$landline','$mobile','$state','$city','$address','$gst',
				                                                '$aadharcard','$story','$profile','$website','$image','$video','$bank_acc','$acc_name','$acc_no','$Ifsc_code')");
							...
							if (!$query) {	
								...
								if($query)
								{
								 $msg = "<div class='alert alert-block alert-success'>
										<button type='button' class='close' data-dismiss='alert'><i class='ace-icon fa fa-times'></i></button>
										<i class='ace-icon fa fa-check green'></i> &nbsp; Thank You! Organic Consultant Add successfully.</div>"; 
								}
							}
						} 
						...
						{	
						   ...
						   $rand2 = rand(100000,999999);
					        ...
					        $query = mysqli_query($db, "UPDATE `tbl_org_consultant` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`profile`='$profile',`website`='$website'`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code' WHERE `id` ='$id'");
							  }  
							  if(!empty($fil1))
							  {	
								
					        $query = mysqli_query($db, "UPDATE `tbl_org_consultant` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`company_images`='$image',`website`='$website',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code' WHERE `id` ='$id'");
							  } 
							  if(!empty($fil2))
							  {	
								
					        $query = mysqli_query($db, "UPDATE `tbl_org_consultant` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`video`='$video',`website`='$website',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code' WHERE `id` ='$id'");
							  }  
							else
							  {
								$query = mysqli_query($db, "UPDATE `tbl_org_consultant` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`website`='$website',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code' WHERE `id` ='$id'");
							  }	                                     
								...
								if($query)
								{
								 $msg = "<div class='alert alert-block alert-success'>
										<button type='button' class='close' data-dismiss='alert'><i class='ace-icon fa fa-times'></i></button>
										<i class='ace-icon fa fa-check green'></i> &nbsp; Thank You! Organic Consultant Updated successfully.</div>"; 
								}
						}
					...
					<?php $user_check; //echo $date_ymd; //Display User Name ?> 
						...
						<div class="row <?php if(isset($_GET['id'])){} else {echo "hideshow"; } ?>" id="addorganicconsultants">
							<div class="col-xs-12">
	<!---------------------------PAGE CONTENT BEGINS------------------------------>
                    ...
                    <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
						    ...
						    <!--	<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-8">
										    <select class="col-xs-10 col-sm-5" value="<?php echo $row["types"]; ?>" name="visitq" >
						...
						<div class="row">
							<div class="col-xs-12 datatable_wrapper">
								...
								<?php
									...
									$sql = "select * from `tbl_org_consultant`";
								...
								<table id="myTable" class="display nowrap table  table-striped table-responsive" style="overflow-x:auto">  
									...
									?>
										...
										<td><a href="addorganicconsultants.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true" style="color:#007700"></i></a> </td>
										<td><a href="addorganicconsultants.php?did=<?php echo $row['id'];?>" onclick="return confirm('<?php echo "Do you want to delete?";?>')"><i class="fa fa-trash-o fa-2x" aria-hidden="true" style="color:#007700"></i></a> </td>
															</tr> 
									<?php $no++;
									} ?>
									</tbody>  
