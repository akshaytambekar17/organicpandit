					...
					<?php
						...
						{	
							...
							$id= $_GET['id'];
							$sql = "select * from `tbl_processor` where id='$id'";
						...
						{
							$did= $_GET['did'];
							$sql = "delete  from `tbl_processor` where `id`='$did'";
				...
				$query = mysqli_query($db, "INSERT INTO `tbl_processor`(`fullname`, `username`,`email`,`landline`,`mobile`,`state`,`city`,`address`,`gst`,
				                                                `aadharcard`,`story`,`profile`,`certification`,`certify_img`,`visitq`,`test_report`,`video`,`acc_bank`,`acc_name`,`acc_no`,`ifsc_code`,`ceo`) 
				                                             VALUES ('$fullname','$username','$email','$landline','$mobile','$state','$city','$address','$gst',
				                                                '$aadharcard','$story','$profile','$certification','$image','$visit','$test_report','$video','$bank_acc','$acc_name','$acc_no','$Ifsc_code','$ceo')");
							...
							if (!$query) {	
								...
								if($query)
								{
								 $msg = "<div class='alert alert-block alert-success'>
										<button type='button' class='close' data-dismiss='alert'><i class='ace-icon fa fa-times'></i></button>
										<i class='ace-icon fa fa-check green'></i> &nbsp; Thank You! Processor Add successfully.</div>"; 
								}
							}
						} 
						...
						{	
						   ...
						   $rand2 = rand(100000,999999);
					        ...
					        $query = mysqli_query($db, "UPDATE `tbl_processor` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`profile`='$profile',`certification`='$certification',`visitq`='$visit',`test_report`='$test_report',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`ceo`='$ceo' WHERE `id` ='$id'");
							  }  
							  if(!empty($fil1))
							  {	
								
					        $query = mysqli_query($db, "UPDATE `tbl_processor` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`certify_img`='$image',`certification`='$certification',`visitq`='$visit',`test_report`='$test_report',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`ceo`='$ceo' WHERE `id` ='$id'");
							  } 
							  if(!empty($fil2))
							  {	
								
					        $query = mysqli_query($db, "UPDATE `tbl_processor` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`video`='$video',`certification`='$certification',`visitq`='$visit',`test_report`='$test_report',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`ceo`='$ceo' WHERE `id` ='$id'");
							  }  
							else
							  {
								$query = mysqli_query($db, "UPDATE `tbl_processor` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`certification`='$certification',`visitq`='$visit',`test_report`='$test_report',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`ceo`='$ceo' WHERE `id` ='$id'");
							  }	                                     
								...
								if($query)
								{
								 $msg = "<div class='alert alert-block alert-success'>
										<button type='button' class='close' data-dismiss='alert'><i class='ace-icon fa fa-times'></i></button>
										<i class='ace-icon fa fa-check green'></i> &nbsp; Thank You! Processor Updated successfully.</div>"; 
								}
						}
					...
					<?php $user_check; //echo $date_ymd; //Display User Name ?> 
						...
						<div class="row <?php if(isset($_GET['id'])){} else {echo "hideshow"; } ?>" id="addprocessor">
							<div class="col-xs-12">
	<!---------------------------PAGE CONTENT BEGINS------------------------------>
							...
							<div class="col-xs-12 datatable_wrapper">
								...
								<table id="myTable" class="display nowrap table  table-striped table-responsive" style="overflow-x:auto">  
									...
									?>
										...
										<td><a href="addprocessor.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true" style="color:#007700"></i></a> </td>
										<td><a href="addprocessor.php?did=<?php echo $row['id'];?>" onclick="return confirm('<?php echo "Do you want to delete?";?>')"><i class="fa fa-trash-o fa-2x" aria-hidden="true" style="color:#007700"></i></a> </td>
															</tr> 
									<?php $no++;
									} ?>
									</tbody>  
