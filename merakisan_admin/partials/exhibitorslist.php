					...
					<?php
						...
						{	
							...
							$id= $_GET['id'];
							$sql = "select * from `tbl_exhibitors` where id='$id'";
							...
							$profile = $row["profile"];
							$website = $row["website"];
							$image = $row["company_images"];
							$catalouge = $row["catalouge"];
							$video = $row["video"];
						...
						{
							$did= $_GET['did'];
							$sql = "delete  from `tbl_exhibitors` where `id`='$did'";
						...
						{	
						   ...
						   $fil3 = $_FILES['myfile3']['name'];
						   $rand3 = rand(100000,999999);
							$fullname = $_POST["fullname"];
							$ceo = $_POST["ceo"];
							$cname = $_POST["comapny_name"];
							...
							$catalouge = mysqli_real_escape_string($db, $catalouge);
							...
							$Ifsc_code = mysqli_real_escape_string($db, $Ifsc_code);
							 ...
							 empty($aadharcard) || empty($story) || empty($profile) || empty($website) || empty($image) || empty($catalouge) || empty($video) ||
							  empty($bank_acc) || empty($acc_name) || empty($acc_no) || empty($Ifsc_code) )
							{ 
							...
							// Where the file is going to be stored
								...
								$filename = $path['filename'];
								$ext = $path['extension'];
								$temp_name = $_FILES['myfile3']['tmp_name'];
								$path_filename_ext = $target_dir.$filename.".".$ext; 
									//check file type
									// Check if file already exists
									if (file_exists($path_filename_ext)) {
									...
									{ 
										if (($_FILES["myfile3"]["type"] == "image/jpg") || ($_FILES["myfile3"]["type"] == "image/jpeg")||($_FILES["myfile3"]["type"] == "image/JPEG")||($_FILES["myfile3"]["type"] == "image/png"))
										{
				...
				$query = mysqli_query($db, "INSERT INTO `tbl_exhibitors`(`fullname`, `username`,`email`,`landline`,`mobile`,`state`,`city`,`address`,`gst`,
				                                                `aadharcard`,`story`,`profile`,`website`,`company_images`,`catalouge`,`video`,`acc_bank`,`acc_name`,`acc_no`,`ifsc_code`,`ceo`,`comapny_name`) 
				                                             VALUES ('$fullname','$username','$email','$landline','$mobile','$state','$city','$address','$gst',
				                                                '$aadharcard','$story','$profile','$website','$image','$catalouge','$video','$bank_acc','$acc_name','$acc_no','$Ifsc_code','$ceo','$cname')");
							...
							if (!$query) {	
								...
								if($query)
								{
								 $msg = "<div class='alert alert-block alert-success'>
										<button type='button' class='close' data-dismiss='alert'><i class='ace-icon fa fa-times'></i></button>
										<i class='ace-icon fa fa-check green'></i> &nbsp; Thank You! Exhibitor Add successfully.</div>"; 
								}
							}
						} 
						...
						{	
						   ...
						   $rand3 = rand(100000,999999);
					        ...
					        $query = mysqli_query($db, "UPDATE `tbl_exhibitors` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`profile`='$profile',`website`='$website',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`ceo`='$ceo',`comapny_name`='$cname' WHERE `id` ='$id'");
							  }  
							  if(!empty($fil1))
							  {	
								
					        $query = mysqli_query($db, "UPDATE `tbl_equipment` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`company_images`='$image',`website`='$website',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`ceo`='$ceo',`comapny_name`='$cname' WHERE `id` ='$id'");
							  } 
							  if(!empty($fil2))
							  {	
								
					        $query = mysqli_query($db, "UPDATE `tbl_exhibitors` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`video`='$video',`website`='$website',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`ceo`='$ceo',`comapny_name`='$cname' WHERE `id` ='$id'");
							  }
							  if(!empty($fil3))
							  {	
								
					        $query = mysqli_query($db, "UPDATE `tbl_exhibitors` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`catalouge`='$catalouge',`website`='$website',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`ceo`='$ceo',`comapny_name`='$cname' WHERE `id` ='$id'");
							  }  
							else
							  {
								$query = mysqli_query($db, "UPDATE `tbl_exhibitors` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`website`='$website',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`ceo`='$ceo',`comapny_name`='$cname' WHERE `id` ='$id'");
							  }	                                     
								...
								if($query)
								{
								 $msg = "<div class='alert alert-block alert-success'>
										<button type='button' class='close' data-dismiss='alert'><i class='ace-icon fa fa-times'></i></button>
										<i class='ace-icon fa fa-check green'></i> &nbsp; Thank You! Exhibitor Updated successfully.</div>"; 
								}
						}
					...
					<?php $user_check; //echo $date_ymd; //Display User Name ?> 
						...
						<div class="row <?php if(isset($_GET['id'])){} else {echo "hideshow"; } ?>" id="addexhibitors">
							<div class="col-xs-12">
	<!---------------------------PAGE CONTENT BEGINS------------------------------>
                    ...
                    <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
							<div class="row">
						        ...
						        <div class="col-md-6">
									<div class="form-group">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Catalouge : <font style="color:red">*</font></label>
										<div class="col-sm-8">
										    <?php if(!empty($catalouge)) { ?>
										    <img src="profile4/<?php echo $catalouge;?>" height="40px" width="40px"> 
										    <?php }?>
										    <input type="file" name="myfile3" class ="col-xs-10" value="<?php echo $catalouge;?>"> 
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Company Name : <font style="color:red">*</font></label>
										<div class="col-sm-8">
											<input type="text" name="comapny_name" id="form-field-1-1" placeholder="Enter Company Name " class="col-xs-8" value="<?php echo $cname;?>" required=""/>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-xs-12 datatable_wrapper">
								...
								<?php
									...
									$sql = "select * from `tbl_exhibitors`";
								...
								<table id="myTable" class="display nowrap table  table-striped table-responsive" style="overflow-x:auto">  
									...
									?>
										...
										<td><?php echo $row["comapny_name"]; ?></td>
										...
										<td><img src="profile2/<?php echo $row["company_images"];?>" height="40px" width="40px"></td>
										<td><img src="profile4/<?php echo $row["catalouge"];?>" height="40px" width="40px"></td>
										...
										<td><a href="addexhibitors.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true" style="color:#007700"></i></a> </td>
										<td><a href="addexhibitors.php?did=<?php echo $row['id'];?>" onclick="return confirm('<?php echo "Do you want to delete?";?>')"><i class="fa fa-trash-o fa-2x" aria-hidden="true" style="color:#007700"></i></a> </td>
															</tr> 
									<?php $no++;
									} ?>
									</tbody>  
