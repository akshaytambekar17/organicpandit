				...
				<?php
						...
						{	
							...
							$id= $_GET['id'];
							$sql = "select * from `tbl_fpo` where id='$id'";
						...
						{
							$did= $_GET['did'];
							$sql = "delete  from `tbl_fpo` where `id`='$did'";
						   ...
						   $rand2 = rand(100000,999999);
							...
							$ceo = mysqli_real_escape_string($db, $ceo);
							 ...
							 empty($aadharcard) || empty($story) || empty($profile) || empty($certification) ||
							  empty($visit) || empty($test_report) || empty($bank_acc) || empty($acc_name) || empty($acc_no) || empty($Ifsc_code) || empty($farmer) || empty($ceo))
							{ 
				...
				$query = mysqli_query($db, "INSERT INTO `tbl_fpo`(`fullname`, `username`,`email`,`landline`,`mobile`,`state`,`city`,`address`,`gst`,
				                                                `aadharcard`,`story`,`profile`,`certification`,`certify_img`,`visitq`,`test_report`,`video`,`acc_bank`,`acc_name`,`acc_no`,`ifsc_code`,`no_farmer`,`ceo`) 
				                                             VALUES ('$fullname','$username','$email','$landline','$mobile','$state','$city','$address','$gst',
				                                                '$aadharcard','$story','$profile','$certification','$image','$visit','$test_report','$video','$bank_acc','$acc_name','$acc_no','$Ifsc_code','$farmer','$ceo')");
							...
							if (!$query) {	
								...
								if($query)
								{
								 $msg = "<div class='alert alert-block alert-success'>
										<button type='button' class='close' data-dismiss='alert'><i class='ace-icon fa fa-times'></i></button>
										<i class='ace-icon fa fa-check green'></i> &nbsp; Thank You! FPO Add successfully.</div>"; 
								}
							}
						} 
						...
						{	
						   ...
						   $rand2 = rand(100000,999999);
					        ...
					        $query = mysqli_query($db, "UPDATE `tbl_fpo` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`profile`='$profile',`certification`='$certification',`visitq`='$visit',`test_report`='$test_report',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`no_farmer`='$farmer',`ceo`='$ceo' WHERE `id` ='$id'");
							  }  
							  if(!empty($fil1))
							  {	
								
					        $query = mysqli_query($db, "UPDATE `tbl_fpo` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`certify_img`='$image',`certification`='$certification',`visitq`='$visit',`test_report`='$test_report',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`no_farmer`='$farmer',`ceo`='$ceo' WHERE `id` ='$id'");
							  } 
							  if(!empty($fil2))
							  {	
								
					        $query = mysqli_query($db, "UPDATE `tbl_fpo` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`video`='$video',`certification`='$certification',`visitq`='$visit',`test_report`='$test_report',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`no_farmer`='$farmer',`ceo`='$ceo' WHERE `id` ='$id'");
							  }  
							else
							  {
								$query = mysqli_query($db, "UPDATE `tbl_fpo` SET `fullname`='$fullname', `username`='$username',`email`='$email',`landline`='$landline',`mobile`='$mobile',`state`='$state',`city`='$city',`address`='$address',`gst`='$gst',
				                                                `aadharcard`='$aadharcard',`story`='$story',`certification`='$certification',`visitq`='$visit',`test_report`='$test_report',`acc_bank`='$bank_acc',`acc_name`='$acc_name',`acc_no`='$acc_no',`ifsc_code`='$Ifsc_code',`no_farmer`='$farmer',`ceo`='$ceo' WHERE `id` ='$id'");
							  }	                                     
								...
								if($query)
								{
								 $msg = "<div class='alert alert-block alert-success'>
										<button type='button' class='close' data-dismiss='alert'><i class='ace-icon fa fa-times'></i></button>
										<i class='ace-icon fa fa-check green'></i> &nbsp; Thank You! FPO Updated successfully.</div>"; 
								}
						}
					...
					<?php $user_check; //echo $date_ymd; //Display User Name ?> 
						...
						<div class="row <?php if(isset($_GET['id'])){} else {echo "hideshow"; } ?>" id="addfpo">
							<div class="col-xs-12">
	<!---------------------------PAGE CONTENT BEGINS------------------------------>
                    ...
                    <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Farmer No. : <font style="color:red">*</font></label>
										<div class="col-sm-8">
											<input type="text" name="no_farmer" id="form-field-1-1" placeholder="Enter No. " class="col-xs-8" value="<?php echo $farmer;?>" required=""/>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">CEO : <font style="color:red">*</font></label>
										<div class="col-sm-8">
							...
							<div class="col-xs-12 datatable_wrapper">
								...
								<table id="myTable" class="display nowrap table  table-striped table-responsive" style="overflow-x:auto">  
									...
									?>
										...
										<td><img src="profile2/<?php echo $row["certify_img"];?>" height="40px" width="40px"></td>
										...
										<td><?php echo $row["no_farmer"]; ?></td>
										<td><?php echo $row["ceo"]; ?></td>
										<td><a href="addfpo.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true" style="color:#007700"></i></a> </td>
										<td><a href="addfpo.php?did=<?php echo $row['id'];?>" onclick="return confirm('<?php echo "Do you want to delete?";?>')"><i class="fa fa-trash-o fa-2x" aria-hidden="true" style="color:#007700"></i></a> </td>
															</tr> 
									<?php $no++;
									} ?>
									</tbody>  
