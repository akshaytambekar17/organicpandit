							...
							<div class="row">
							    <div class="col-md-6">
									<div class="form-group">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Plan Name : <font style="color:red">*</font></label>
										<div class="col-sm-8">
											<input type="text" name="name" id="form-field-1-1" placeholder="Enter Plan Name" class="col-xs-8" value="<?php echo $name;?>" required=""/>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="amount" id="form-field-1-1" placeholder="Enter Amount" class="col-xs-8" value="<?php echo $amount;?>" required=""/>
										</div>
									</div>
								</div>
								<div class="col-md-6">
