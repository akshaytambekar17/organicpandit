...
include ("includes/db.php");
		...
		<div class="container" style="background:#333333">
				...
				<div class="col-md-10"> 
					<div class="panel"style="margin-bottom: 0; margin-top: 13px;">
						...
						<div class="panel-body">
							<div class="row">
							<?php 
							$rs_result = mysqli_query($db,"SELECT o.`product_name`,o.`offer_price`,o.`product_qty`,p.`unit_value`,p.`price_unit`,o.`offer_price`*o.`product_qty` As `subtotal` FROM `offer_order` o JOIN `product_subadmin` p ON o.`product_id` = p.`product_id` AND o.city_id=p.city_id WHERE o.`order_id`='$Fees_Id'");
							?>
								<div class="col-md-12">
									 <table class="table">
									 <thead>
							...
							<?php
									...
									?>
									 ...
									 <td> <?php echo $row['unit_value']." ".$row['price_unit']; ?></td>
									 <td>Rs.&nbsp;00<?php  ?></td>
			...
			<br>
			<div class="row">
		 <center><button type="submit" onclick="myFunction('printdiv')" class="btn btn-sm btn-primary">Print</button></center>	 
		 </div>
