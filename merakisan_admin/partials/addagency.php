				<div class="page-content">
					<?php
						...
						{	
						    $id= $_GET['id'];
							$sql = "select * from `tbl_agency` where id='$id'";
						...
						{
							$did= $_GET['did'];
							$sql = "delete  from `tbl_agency` where `id`='$did'";
						...
						{	
							...
							{ 
							 ...
							 $query = mysqli_query($db, "INSERT INTO `tbl_agency`(`name`) VALUES ('$ProductName')");
						...
						{	
							 ...
							 $query = mysqli_query($db, "UPDATE `tbl_agency` SET `name`='$ProductName' WHERE `id` ='$id'");
