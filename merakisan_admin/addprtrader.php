				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Trader Product</li>
						<!--	<li> <button class="right btn btn-success" id="show">Add Trader Product</button></li> -->
							<li><a href="exportproducttrader.php"><button class="btn btn-success">Export</button></a></li>
					...
					<?php 
						...
						require_once("partials/producttrader.php");
