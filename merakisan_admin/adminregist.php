				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li><a href="adminregist.php"><button class="btn btn-success">Add New Admin </button></a></li>
							<li> <button class="right btn btn-success" id="show">Add admin</button></li>
							<li><a href="export16.php"><button class="btn btn-success">Export</button></a></li>
						</ul><!-- /.breadcrumb -->
					...
					<!-- ******************* Start page-content *******************-->
					<?php require_once("partials/adminreg.php");?>
					<!-- ******************* /.page-content *******************-->
