				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Location Register </li>
							<li><a href="location.php"><button class="btn btn-success">Add New Location </button></a></li>
							<li> <button class="right btn btn-success" id="show">Add Location</button></li>
							<li><a href="export1.php"><button class="btn btn-success">Export</button></a></li>
						</ul><!-- /.breadcrumb -->
					...
					<!-- ******************* Start page-content *******************-->
					<?php require_once("partials/storereg.php");?>
					<!-- ******************* /.page-content *******************-->
