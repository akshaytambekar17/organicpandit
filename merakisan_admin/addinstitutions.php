			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<!--	<li> <button class="right btn btn-success" id="show">Add Institutions</button></li> -->
							<li><a href="exportinstitutions.php"><button class="btn btn-success">Export</button></a></li>
					...
					<?php 
						...
						require_once("partials/institutionslist.php");
