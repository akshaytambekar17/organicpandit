			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<!--	<li> <button class="right btn btn-success" id="show">Add Trader</button></li> -->
							<li><a href="exporttrader.php"><button class="btn btn-success">Export</button></a></li>
					...
					<?php 
						...
						require_once("partials/traderlist.php");
