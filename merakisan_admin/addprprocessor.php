				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Processor Product</li>
						<!--	<li> <button class="right btn btn-success" id="show">Add Processor Product</button></li> -->
							<li><a href="exportproductprocessor.php"><button class="btn btn-success">Export</button></a></li>
					...
					<?php 
						...
						require_once("partials/productprocessor.php");
